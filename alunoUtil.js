...
function preencheTabela(alunos){
    ...
    alunos.forEach(aluno => {
        ...
        const[tdId, tdNome, tdNota1, tdNota2, tdMedia, tdGrau, tdAcoes]=
        ['td','td','td','td','td', 'td','td'].map(tagTd=> document.createElement(tagTd));
        tdId.textContent=id;
        ...
        linha.append(tdId,tdNome,tdNota1,tdNota2,tdMedia,tdGrau,tdAcoes);
